...
I went ahead and made an [exploratory wrapper](https://github.com/cark/clojure-win-cli-wrap) using Nim. Been using -EncodedCommand, thus avoiding the temp file.
** Rewrite
